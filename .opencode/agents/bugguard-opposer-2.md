---
description: BugGuard Opposing Agent 2 — Repo-Truth Skeptic. Proves repo contracts allow the behaviour, docs say it is intentional, tests already cover it, or another layer handles it.
mode: subagent
