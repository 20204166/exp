...
- [x] **Step 3:** Log findings to the bug ledger; no vulnerability met the ledger threshold. The ancestry divergence is recorded in the Mode D review as a deferred hardening opportunity; any fix goes through Mode A exactly as Phase 3.
